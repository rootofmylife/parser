...
from supar.modules.normalization import LayerNormalization
from supar.modules.product_attention import ScaledDotProductAttention
...
class MultiHeadAttention(nn.Module):
    ...
    def pad_and_rearrange(self, q_s, k_s, v_s, batch_idxs):
        ...
        invalid_mask = q_s.new_ones((mb_size, len_padded), dtype=bool)
