...
from supar.modules.dropout import FeatureDropout
...
class LabelAttention(nn.Module):
    ...
    def __init__(self, lal_combine_as_self, d_model, d_k, d_v, d_l, d_proj, use_resdrop=True, q_as_matrix=False, residual_dropout=0.1, attention_dropout=0.1, d_positional=None):
        ...
        self.combine_as_self = lal_combine_as_self # Using the Combination Method of Self-Attention
