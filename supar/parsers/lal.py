...
from supar.models import (LabelAttentionDependencyModel)
...
class LabelAttentionDependencyParser(Parser):

    NAME = 'label-attention-dependency'
    MODEL = LabelAttentionDependencyModel
